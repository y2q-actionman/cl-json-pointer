...
(1am:test test-extend-list
  (1am:is (equal (cl-json-pointer::extend-list nil 0)
                 nil))
  (1am:is (equal (cl-json-pointer::extend-list nil 2)
                 '(nil nil)))
  (1am:is (equal (cl-json-pointer::extend-list nil 2 :initial-element 0)
                 '(0 0)))
  (1am:is (equal (cl-json-pointer::extend-list nil -2)
                 nil))
  (let ((lis (list 1 2)))
    (1am:is (equal (cl-json-pointer::extend-list lis -2)
                   '(1 2)))
    (1am:is (equal (cl-json-pointer::extend-list lis 0)
                   '(1 2)))
    (1am:is (equal (cl-json-pointer::extend-list lis 1)
                   '(1 2)))
    (1am:is (equal (cl-json-pointer::extend-list lis 2)
                   '(1 2)))
    (1am:is (equal (cl-json-pointer::extend-list lis 3)
                   '(1 2 nil)))
    (1am:is (equal (cl-json-pointer::extend-list lis 4)
                   '(1 2 nil nil)))
    (1am:is (equal (cl-json-pointer::extend-list lis 5)
                   '(1 2 nil nil nil)))
    (1am:is (eq (cl-json-pointer::extend-list lis 8) lis)))
  (1am:is (equal (cl-json-pointer::extend-list (list 1 2) 0 :initial-element #\a)
                 '(1 2)))
  (1am:is (equal (cl-json-pointer::extend-list (list 1 2) 5 :initial-element #\a)
                 '(1 2 #\a #\a #\a)))
  t)
